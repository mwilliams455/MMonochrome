...
def main() -> None:
    ...
    report = {
        ...
        "closed_equation": {
            ...
            "note": "The parity-reduction implementation is retained because integer rounding differs by descriptor parity even when the rational scale is descriptor/4.",
        },
    }
    ...
    with (a.outdir / "MM_SHARPNESS_MODIFIER_PROBE.txt").open("w") as f:
        f.write("M Monochrom sharpness modifier probe\n\n")
